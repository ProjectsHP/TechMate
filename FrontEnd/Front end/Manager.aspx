<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Manager.aspx.cs" Inherits="Front_end.Manager" %>
                                                    ...
                                                    <div class="teacher" style="height: 200px">
                                                        <div class="feature_block">
                                                            ...
                                                            <div class="feature_txt">
                                                                <h4>Add stock</h4>
                                                                <p>Increase stock count of existing components                                                                        </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="feature_block_wrap">
                                                    <div class="certificate" style="height: 200px">
                                                        <div class="feature_block">
                                                            ...
                                                            <div class="feature_txt">
                                                                <h4>Manage stock</h4>
                                                                <p>Search and update stock count of existing components</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-sm-3 col-md-3 col-xs-6">
                            <div class="funfact expert text-center mb-sm-30">
                                ...
                                <div class="counts">
                                    ...
                                    <h4 class="title">Fulfiled orders</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-3 col-xs-6">
                        ...
                        <div class="col-sm-3 col-md-3 col-xs-6">
                            <div class="funfact student second_one text-center mb-sm-30">
                                ...
                                <div class="counts">
                                    ...
                                    <h4 class="title">Not Finalized</h4>
                                </div>
                            </div>
                        </div>
